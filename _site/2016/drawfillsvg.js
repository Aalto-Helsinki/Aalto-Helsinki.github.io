!function(a){
	...
	var d = {WebkitTransition:"webkitTransitionEnd",
	...
	c.prototype._fillPath = function(a){
		a.addEventListener(e,function(){
			...
			a.style.transition=a.style.WebkitTransition="fill-opacity 1s ease-in-out, stroke-opacity 1s ease-in-out",
			a.style.fillOpacity=1,a.style.strokeOpacity=1});
	},
	c.prototype.replay = function(){this._initAnimation()},
	a.DrawFillSVG = c;
}(window);